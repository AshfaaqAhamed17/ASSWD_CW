...
<div class="container-fluid auth-cont">
    <div class="row h-100">
        ...
        <div id="slider">
                <img class="slide active" src="https://images.unsplash.com/photo-1444703686981-a3abbc4d4fe3?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8OHx8Y292ZXIlMjBwaG90b3xlbnwwfHwwfHw%3D&auto=format&fit=crop&w=500&q=60" style="height: 400px;">
